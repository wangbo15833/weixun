...
class Play extends MY_Controller{
    ...
    function get_category(){
        ...
        $categorys = $this->h_model->get_category(1);
        $arrs = array();
    ...
    function showPlaylList($type=3){
        ...
        $req_url = 'play/showPlaylList/'.$type;
        ...
        $this->load->view('meituan/play_List',$paramData);
    }
    ...
    function happyEdit(){
        ...
        $this->load->view('meituan/play_Edit',array('citys'=>$citys, 'categorys'=> $categorys, 'g_info'=> $g_info));
    }
    ...
    function do_load(){
        ...
        $g_info = $this->h_model->detail($params['g_id']);
        ...
        $this->load->view('meituan/play_ShowPic',array('g_info'=>$g_info,'gourmetid'=> $params['g_id'], 'lists' => $newList, 'pgc' => $cs,'cid'=>$params['c_id']));
    }
    ...
    function do_upload(){
        ...
        if($state == 1){
            $h_info = $this->h_model->detail($gourmetid);
            ...
            //跳转至上传页面
            $this->load->view('meituan/play_AddPic',array('cate'=>$cate,'cate_s'=>$datas,'gourmetid'=>$gourmetid,'h_info'=>$h_info,'cid'=>$c_id));
            return;
        }
