...
class Live extends MY_Controller{
    ...
    function get_category(){
        ...
        $categorys = $this->l_model->get_category();
        $arrs = array();
    ...
    function showLiveList($type=5){
        ...
        $req_url = 'live/showLiveList/'.$type;
        ...
        $this->load->view('meituan/live_List',$paramData);
    }
    ...
    function liveEdit(){
        ...
        $this->load->view('meituan/live_Edit',array('citys'=>$citys, 'categorys'=> $categorys, 'g_info'=> $g_info));
    }
    ...
    function do_load(){
        ...
        $this->load->view('meituan/live_ShowPic',array('g_info'=>$g_info,'gourmetid'=> $params['g_id'], 'lists' => $newList, 'pgc' => $cs,'cid'=>$params['c_id']));
    }
    ...
    function do_upload(){
        ...
        if($state == 1){
            ...
            //跳转至上传页面
            $this->load->view('meituan/live_AddPic',array('cate'=>$cate,'cate_s'=>$datas,'gourmetid'=>$gourmetid,'h_info'=>$h_info,'cid'=>$c_id));
            return;
        }
