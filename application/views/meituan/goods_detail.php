...
<?php startblock('content') ?>
    ...
    <div id="content">
        <input type="hidden" id="hid_id" name="hid_id" value="<?php echo $commoditys['g_id']?>"/>
        <input type="hidden" id="hid_cid" name="hid_cid" value="<?php echo $cid?>"/>

        <div class="cf" id="deal-intro">
            <h2 class="deal-title">【<?php echo $commoditys['areaid'] ?>】<?php echo $commoditys['g_title'] ?></h2>
            <div class="deal-buy-cover-img">
                <img width="462" height="280"  src="<?php if($commoditys['gphoto']){ echo $commoditys['gphoto']; }else{?>http://p0.meituan.net/deal/__12299505__9489745.jpg<?php }?>" alt="<?php echo $commoditys['g_title'] ?>">
                <p style="margin: 5px 5px 5px 10px">
                    <a style="float: left" href="<?php echo WEB_URL?>goods/do_load?gid=<?php echo $commoditys['g_id']?>&cid=<?php echo $cid?>">所有图片</a>
                    <a  href="<?php echo WEB_URL?>goods/do_upload?gid=<?php echo $commoditys['g_id']?>&cid=<?php echo $cid?>"/>
                    <span style="" class="utop"></span>我来上传</a></p>
            </div>
            <div class="main">
                <div class="deal-discount">
                    <span class="price"><span class="symbol-RMB"></span>单价：<?php echo $commoditys['cprice'] ?>元</span>
                </div>

                <div class="deal-info">
                    <p class="p_show">地址：<?php echo $commoditys['address'] ?></p>
            ...
            <div class="mainbox cf">
                <div class="main" id="yui_3_8_0_2_1369363581263_80">
                    ...
                    <div class="user-reviews" id="anchor-reviews">
                        <div class="standard-bar">会员评价<a href="javascript:void(0)" style="float: right">我要评价</a></div>
                        <form action="" method="post" id="" name="">
                            <div class="overview">
                                <div class="overview-head cf">
                                    <h3 class="overview-title">总体评价</h3>
                                    <div class="overview-feedback to-rate"></div>
                                </div>
                                <div class="" style="margin: 5px; padding: 5px;">
                                    <div class="form-block rating-block rating-changes" id="J_shop-rating">
                                    ...
                                    <div class="form-block rating-block rating-changes" id="J_shop-rating2">
                                    ...
                                    <div class="form-block rating-block rating-changes" id="J_shop-rating3">
