        ...
        <div class="cf" id="deal-intro">
            ...
            <div class="deal-buy-cover-img">
                ...
                <p style="margin: 5px 5px 5px 10px">
                    <a style="float: left" href="<?php echo WEB_URL?>live/do_load?gourmetid=<?php echo $commoditys['id']?>&cid=<?php echo $channelId?>">所有图片</a>
                    <a  href="<?php echo WEB_URL?>live/do_upload?gourmetid=<?php echo $commoditys['id']?>&cid=<?php echo $channelId?>"/>
    ...
    <script>//点击完善资料、路径
        $('.btn_bg').click(function () {
            if (parseInt($('#hid_id').val()) > 0)
                window.location.href = base_url + 'live/liveEdit?g_id=' + $('#hid_id').val();
        });</script>
<?php endblock() ?>