        ...
        <div class="cf" id="deal-intro">
            ...
            <div class="deal-buy-cover-img">
                ...
                <p style="margin: 5px 5px 5px 10px">
                    <a style="float: left" href="<?php echo WEB_URL?>happy/do_load?gourmetid=<?php echo $commoditys['id']?>&cid=<?php echo $channelId?>">所有图片</a>
                    <a  href="<?php echo WEB_URL?>happy/do_upload?gourmetid=<?php echo $commoditys['id']?>&cid=<?php echo $channelId?>"/>
