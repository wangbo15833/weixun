        ...
        <?php if($n ==1):?>
            <?php foreach($list as $item):?>
                <div class="item <?php if(($j%2) == 0):?>odd<?php endif; $j++;?>" id="" >
                    <div class="cover">
                        <a href="<?php echo WEB_URL?>gourmet/gourmetDetail/<?php echo $item['id']?>" target="_blank">
                            <img width="312" height="189"  src="<?php echo $item['photos']?>" alt=""></a>
                    </div>
                    <h3 ><a title="<?php echo $item['name']?>"   href="<?php echo WEB_URL?>gourmet/gourmetDetail/<?php echo $item['id']?>" target="_blank">
                            <span class="xtitle" style="display: inline"><?php echo $item['name']?></span>
                            <span class="short-title"><?php echo $item['addr']?></span>
                        </a></h3>
                    <p class="detail" style="text-align: left"><a  href="<?php echo WEB_URL?>gourmet/gourmetDetail/<?php echo $item['id']?>" target="_blank" hidefocus="true" class="buy" rel="nofollow">去看看</a>
            ...
            <?php foreach($list as $item):?>
                <div>
                    <div class="list_d_item">
                        <ul>
                            <li>
                                <a  target="_blank" href="<?php echo WEB_URL?>gourmet/gourmetDetail/<?php echo $item['id']?>">
                    ...
                    <div style="height: 70px;text-align: center;margin:0px; padding-top: 10px;">
                        <ul>
                            <li>
                                <a rel="nofollow" class="buy" hidefocus="true" target="_blank" href="<?php echo WEB_URL?>gourmet/gourmetDetail/<?php echo $item['id']?>">去看看</a>
                            </li>
