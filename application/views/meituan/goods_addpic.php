...
<form  name="picUploadForm" id="picUploadForm" method="post" action="<?php echo WEB_URL?>goods/do_upload">
    <div class="upload_photo">
        <div class="upload-tit">
            <h6 class="tit">上传图片-<?php echo $h_info['g_title']?></h6>
        </div>
        ...
        <div class="add_photobox">
            ...
            <div class="photo_end ">
                ...
                <input type="hidden" id="gid" name="gid" value="<?php echo $gid?>">    <!--店铺id-->
