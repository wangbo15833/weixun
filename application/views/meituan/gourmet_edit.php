...
<?php startblock('content') ?>
    ...
    <div class="mainbox">
        ...
        <form id="signup-form" class="common-form" action="<?php echo WEB_URL?>gourmet/updateGourmet" autocomplete="off" method="post">
                            ...
                            <div class="field-group">
                                <label for="txtPhone1" class="label">菜系：</label>
                                <select class="form-select-sim form-select-sim-m J_ddlCategory" name="ddlCategory1" id="ddlCategory1">
                                    <?php foreach($categorys as $cateItem):?>
                                        <option ch value="<?php echo $cateItem['id']?>" <?php if($cateItem['id'] == $g_info['type_id']):?>selected="selected"<?php endif;?>><?php echo $cateItem['name']?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
