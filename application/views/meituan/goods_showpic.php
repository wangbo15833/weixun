...
<?php startblock('content') ?>
    <input type="hidden" id="hid_gid" name="hid_gid" value="<?php echo $g_info['g_id']?>">
    <!--面包屑-->
    <div class="trans-nav">
        <div class="crumb">
            <ul>
                <li>
                    <strong><a href="javascript:;" ><?php echo $g_info['g_title']?></a></strong>
        ...
        <a class="btn-upload " title="上传图片" onclick="" href="<?php echo WEB_URL?>happy/do_upload?gourmetid=<?php echo $gourmetid; ?>&cid=<?php echo $cid?>" rel="nofollow">上传图片</a>
    </div>
    <!--end of 面包屑-->
                    ...
                    <li class="J_list">
                        <div class="img">
                            ...
                            <a  target="_blank" href="javascript:;">
                                <img alt="<?php echo $li['name']?>-<?php echo $g_info['g_title']?>" title="点击看大图" src="<?php echo $li['picUrl']?>"></a>
                        </div>
                        <div class="picture-info">
                            <div class="name">
                                <h3>
                                    <?php if($li['name']){ echo $li['name'];}?>
                                </h3>
...
<?php startblock('foot_js')?>
    <script>
        function changeUrl(type, id){
            ...
            if(type == 0){
                window.location.href=base_url+"happy/do_load?gourmetid="+gid;
            }else if(type == 1){
                window.location.href=base_url+"happy/do_load?gourmetid="+gid+"&b_type="+id;
            }else{
                window.location.href=base_url+"happy/do_load?gourmetid="+gid+"&s_type="+id;
            }
        }
