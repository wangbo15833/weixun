        ...
        <table class="shopTable">
            ...
            <?php foreach($shopsList as $item):?>
                    <tr>
                        ...
                        <td width="20%">
                            <a class="showMessage" title="查看" href="<?php echo WEB_URL ?>shops/showShops/<?php echo $item['id']?>"><img src="<?php echo base_url()?>frontend/wxadmin/default/images/icon_view.gif"/></a>
                            <a title="编辑" href="<?php echo WEB_URL ?>shops/getedit/<?php echo $item['id']?>"><img src="<?php echo base_url()?>frontend/wxadmin/default/images/edit.gif" /></a>
                            <a title="删除" href="<?php echo WEB_URL ?>shops/delshops/<?php echo $item['id']?>">
                                <img onClick="return confirm('确定删除:确认后将会删除类别时将删除所属类别下的所有产品数据?\n\n此操作无法恢复!')?true:false;" style="border: 0px;"
                                     src="<?php echo base_url()?>frontend/wxadmin/default/images/del.jpg" /></a>
                        </td>
                    </tr>
                <?php endforeach;?>
            <?php else:?>
