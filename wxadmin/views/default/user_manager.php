       ...
       <div class="commodity_css">
           ...
           <table class="shopTable">
               ...
               <?php foreach($usersData as $item):?>
                <tr>
                   <td width="15%"><?php echo $item['username']?></td>
                   <td width="15%"><?php echo $item['email']?></td>
                   <td width="20%"><?php echo $item['last_ip']?></td>
                   <td width="30%"><?php echo $item['l_time']?></td>
                   <td width="10%"><?php echo $item['c_time']?></td>
                   <td width="10%"><?php if($item['is_status'] != 1):?>
                                    <a href="<?php echo WEB_URL?>user/editUser/<?php echo $item['id']?>/1">通过</a>
                                <?php else: ?><a href="<?php echo WEB_URL?>user/editUser/<?php echo $item['id']?>/2">关闭</a><?php endif;?></td>
                </tr>
            <?php endforeach;?>
            <?php else:?>
                <tr>
